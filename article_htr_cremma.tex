...
\begin{itemize}
  ...
  \item \textbf{CREMMA-Medieval-LAT} (4 documents Lat.s) : extension Lat.e de CREMMA
  \item \textbf{HTRomance Medieval FR} (14 documents français): corpus français du projet HTRomance
  \item \textbf{HTRomance Medieval LAT} (8 documents Lat.s) : corpus Lat. du projet HTRomance
\end{itemize}
...
Justification : Ces modèles couvrent déjà AF et Lat. médiévaux; un fine-tuning sur corpus spécialisé (BnF) est plus efficient qu'un entraînement from-scratch. L'architecture VGSL (Very Geeky Stateless Language) de Kraken ($\sim$5,7 M paramètres) est léger et répond bien au fine-tuning sur GPU cloud.
...
Les auteurs remercient Gallica (BnF) pour l'accès aux images numériques et le projet CREMMA (HTR-United) pour les modèles pré-entraînés et ressources de corpus. Les expériences ont bénéficié des GPUs cloud de Kaggle et Google Colab.
...
\bibitem{cremma2022}
Thibault Clérice, Ariane Pinche, Rose Holley, et Benjamin Kiessling.
\newblock {CREMMA: A Collaborative Research on Medieval Manuscripts Automatic Recognition}.
\newblock \url{https://github.com/HTR-United/cremma-medieval}, 2022.
\newblock HTR-United Repository, CC-BY 4.0.

\bibitem{zenodo7234166}
{CREMMA Project}.
\newblock {cremma\_generic\_2022-04-20 (cremma-medieval\_best.mlmodel)}, 2022.
\newblock DOI: 10.5281/zenodo.7234166. \url{https://zenodo.org/records/7234166}.

\bibitem{zenodo7631619}
{CREMMA Project}.
\newblock {cremma-generic-1.0.1.mlmodel}, 2023.
\newblock DOI: 10.5281/zenodo.7631619. \url{https://zenodo.org/records/7631619}.

\bibitem{kiessling2019kraken}
Benjamin Kiessling, Robin Tissot, Claire Stützenberger, et Daniel Perls.
\newblock {Kraken—a Universal Text Recognizer for the Humanities}.
\newblock {\em arXiv preprint arXiv:1904.04646}, 2019.

\bibitem{clahe1987}
Stephen~M. Pizer, E.~Philip Amburn, John~D. Austin, et al.
\newblock {Adaptive Histogram Equalization and its Variations}.
\newblock {\em Computer vision, graphics, and image processing}, 39(3):355--368, 1987.

\bibitem{sauvola2000}
Jaakko Sauvola et Matti Pietik{\"a}inen.
\newblock {Adaptive document image binarization}.
\newblock In {\em Proceedings. 15th International Conference on Pattern Recognition}, volume~1, pages 147--152. IEEE, 2000.
...
\bibitem{pytorchlightning2019}
William Falcon.
\newblock {PyTorch Lightning}.
\newblock \url{https://github.com/PyTorchLightning/pytorch-lightning}, 2019.

\bibitem{htr-united2022}
Thibault Clérice, Hugo Scheithauer, Vincent Christlein, et al.
\newblock {HTR-United: A Framework and Community for Sharing Annotated Datasets in Handwritten Text Recognition}.
\newblock {\em Frontiers in Computer Science}, 4:884367, 2022.

\bibitem{gallica2023}
{Bibliothèque nationale de France}.
\newblock {Gallica: The Digital Library of the Bibliothèque nationale de France}, 2023.
\newblock \url{https://gallica.bnf.fr}.

\bibitem{dell2015deep}
Maria Dell.
\newblock {A Deep Learning Approach to Medieval Handwriting Recognition}.
\newblock Master's thesis, University of Bern, 2015.

\bibitem{covid2018high}
Patrick~M. Ciarelli et al.
\newblock {High Performance Medieval Handwriting Recognition with Deep Learning}.
\newblock In {\em Digital Humanities 2018 Proceedings}, 2018.

\bibitem{vgsl2017}
Baoguang Shi, Xiang Bai, et Cong Yao.
\newblock {A Little Is Enough: Unsupervised Learning with Small-Scale Unlabeled Surface-level Linguistic Data}.
\newblock {\em arXiv preprint arXiv:1612.07748}, 2016.
\newblock Architecture VGSL d'origine.

\bibitem{transfer_learning2019}
Fuzhen Zhuang, Zhiyuan Qi, Kuangqi Dou, et al.
\newblock {A Survey on Transfer Learning}.
\newblock {\em IEEE transactions on knowledge and data engineering}, 26(9):1761--1785, 2019.

\bibitem{attention_ocr2017}
Baoguang Shi, Minghui Yang, Xiamou Wang, et al.
\newblock {Attention-Based Extraction of Structured Information from Street View Imagery}.
\newblock In {\em 2017 14th IAPR International Conference on Document Analysis and Recognition (ICDAR)}, pages 528--533. IEEE, 2017.

\bibitem{crowdsourcing_htr2020}
Peter~A. Stokes et Benjamin Kiessling.
\newblock {Crowdsourcing Ground Truth for Handwritten Text Recognition}.
\newblock {\em Journal of the Japanese Association for Digital Humanities}, 5:16, 2020.

\bibitem{huggingface2020}
Thomas Wolf et al.
\newblock {Hugging Face: The Pulse of the Open Source Machine Learning Community}, 2020.
\newblock \url{https://huggingface.co}.

\bibitem{arxiv_deep_learning2021}
Alexei Dosovitskiy, Lucas Beyer, Alexander Kolesnikov, et al.
\newblock {An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale}.
\newblock {\em arXiv preprint arXiv:2010.11929}, 2021.
\newblock Vision Transformers — architecture alternative.

\bibitem{medieval_scripts2017}
Patrick~M. Ciarelli.
\newblock {The Paleographer's Art: Automated Analysis of Medieval Manuscript Scripts}.
\newblock {\em Digital Humanities Quarterly}, 11(3):1--30, 2017.

\bibitem{cremma_medieval_lat2023}
{CREMMA Project}.
\newblock {CREMMA-Medieval-LAT: Lat. Manuscripts Corpus}.
\newblock \url{https://github.com/HTR-United/CREMMA-Medieval-LAT}, 2023.
\newblock CC-BY 4.0.

\bibitem{htromance_medieval2023}
{HTRomance Project}.
\newblock {HTRomance: A Medieval Manuscript Corpus for Old French and Lat.}.
\newblock \url{https://github.com/HTRomance-Project}, 2023.
\newblock CC-BY 4.0.

\bibitem{cer_wer_metrics2006}
Marina Sokolova et Guy Lapalme.
\newblock {The Relationship Between Recall and Precision}.
\newblock {\em Journal of Machine Learning Technology}, 1:23--28, 2006.
\newblock Définitions du Character and Word Error Rate.

\bibitem{data_augmentation_images2021}
Ekin~D. Cubuk, Barret Zoph, Jon Shlens, et Qing~V. Shi.
\newblock {RandAugment: Practical Automated Data Augmentation with a Reduced Search Space}.
\newblock In {\em Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition Workshops}, pages 702--712, 2021.

\bibitem{batch_norm2015}
Sergey Ioffe et Christian Szegedy.
\newblock {Batch Normalization: Accelerating Deep Network Training by Reducing Internal Covariate Shift}.
\newblock In {\em International Conference on Machine Learning}, pages 448--456. PMLR, 2015.

\bibitem{fp16_training2018}
Paulius Micikevicius, Sharan Narang, Jon Alben, et al.
