...
\begin{itemize}
  ...
  \item \textbf{CREMMA-Medieval-LAT} (12 documents Lat.s) : extension Lat.e de CREMMA
  \item \textbf{HTRomance Medieval FR} : corpus français du projet HTRomance
  \item \textbf{HTRomance Medieval LAT} : corpus Lat. du projet HTRomance
\end{itemize}
...
\begin{tabular}{L{1cm}|C{1cm}|C{1cm}|C{1cm}|C{0.8cm}|C{1cm}}
\toprule
...
BnF fr. 837 & AF & XIIIe & \textit{Gothic Textualis} & 150 & CIHAM Fabliaux \\
BnF fr. 1593 & AF & XIIIe & \textit{Gothic Textualis} & 150 & CIHAM Fabliaux \\
Mazarine 1553 & AF & XIIIe & \textit{Gothic Textualis} & 150 & CIHAM Fabliaux \\
TQ2025 LAT (XIIIe est.) & Lat. & XIIIe & \textit{Textualis (varié)} & 1265 & TranscriboQuest 2025 \\
\midrule
\textbf{TOTAL (brut avant équilibrage)} & & & & \textbf{25288} & \textbf{4 corpus} \\ 
\bottomrule
\end{tabular}
\end{table}
